 ...
 * Provides common settings for all Feign clients in the Product Service
 */
@Configuration
...
public class FeignConfig {
     ...
     * Translates HTTP errors into meaningful application exceptions
     */
    @Bean
     ...
     * - Max 3 attempts
     * - 1-2 second interval between retries
     */
    @Bean
     ...
     * This ensures that inter-service communication maintains the same security context
     */
    @Bean
